...
DATA = {
    ...
    "march_outlets": {
        ...
        "ru_ua": [
            {"name": "moya-provinciya.com.ua", "price": 5.96,  "dr": 52, "traffic_share": 81, "pillar": "RU/UA", "lang": "UA",
             "notion_score": 13, "notion_dims": {"search": 3, "dr": 2, "price_eff": 3, "category": 2, "traffic": 2, "ai_citability": 1},
             "notes": "PICK DR>50 slot — UA language, 81% search, 47.5k traffic, exceptional $/DR.",
             "ai_citability": 1},
            {"name": "euroua.com",             "price": 30.00, "dr": 51, "traffic_share": 55, "pillar": "RU/UA", "lang": "UA",
             "notion_score": 13, "notion_dims": {"search": 3, "dr": 2, "price_eff": 3, "category": 3, "traffic": 1, "ai_citability": 1},
             "notes": "UA language — Finance+Crypto, DR51, 55% search.",
             "ai_citability": 1},
            {"name": "track-package.com.ua",   "price": 3.93,  "dr": 54, "traffic_share": 76, "pillar": "RU/UA", "lang": "UA",
             "notion_score": 12, "notion_dims": {"search": 3, "dr": 2, "price_eff": 3, "category": 2, "traffic": 1, "ai_citability": 1},
             "notes": "UA language — 76% search, 22.6k traffic.",
             "ai_citability": 1},
        ],
        "ae": [
            {"name": "uaehelper.com",          "price": 50.00, "dr": 53, "traffic_share": 86, "pillar": "UAE",
             "notion_score": 14, "notion_dims": {"search": 3, "dr": 2, "price_eff": 3, "category": 2, "traffic": 2, "ai_citability": 2},
             "notes": "TOP PICK — Dubai expat site. DR53, 86% search. ARE = $13,830/user (#1 market).",
             "ai_citability": 2},
            {"name": "thetradable.com",        "price": 100, "dr": 54, "traffic_share": None, "pillar": "UAE",
             ...
             "ai_citability": 1},
            {"name": "theemiratestimes.com",   "price": 99.00, "dr": 44, "traffic_share": 49, "pillar": "UAE",
            ...
            {"name": "khaleejtimes.com",       "price": 200, "dr": 78, "traffic_share": 65, "pillar": "UAE",
             ...
             "notes": "PREMIUM — Top UAE English newspaper. DR78, high AI citability. Over budget but best GEO impact.",
             "ai_citability": 3},
            {"name": "gulfnews.com",           "price": 250, "dr": 82, "traffic_share": 70, "pillar": "UAE",
             "notion_score": 16, "notion_dims": {"search": 3, "dr": 3, "price_eff": 1, "category": 3, "traffic": 3, "ai_citability": 3},
             "notes": "PREMIUM — Major UAE media. DR82. Expensive but highest AI citation potential in region.",
             "ai_citability": 3},
        ],
    },
}
